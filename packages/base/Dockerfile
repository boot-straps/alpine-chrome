...
LABEL org.label-schema.build-date=$BUILD_DATE \
    ...
    org.label-schema.usage="https://github.com/boot-straps/alpine-chrome/blob/master/README.md" \
    org.label-schema.vcs-url="https://github.com/boot-straps/alpine-chrome" \
    org.label-schema.vcs-ref=$VCS_REF \
    org.label-schema.vendor="agcorporation" \
